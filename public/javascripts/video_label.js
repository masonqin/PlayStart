...
$(document).ready(function(){
    $.get("getVideoLabelJson",function(ret){
        labelJSONLib = ret;
    });
});
...
function gameTab(){
    ...
    createGameLabelTable(markDiv,game_class);
...
function appTab(){
    ...
    h4.innerHTML = "应用";
    markDiv.appendChild(h4);
    createAppLabelTable(markDiv,app_class);
...
function createGameLabelTable(markDiv,groupClass){

    var line_num = 9;

    var categoryIndex = 0;
    for(var category in groupClass){
...
//            label.innerHTML = "<input class=\"labelMarkbox\" type=\"checkbox\" id=" +
//                                groupClass.className + "_" +
//                                categoryNode.categoryEnName + "_" +
//                                labelNode.labelEnName +
//                                ">" + labelNode.labelChName;
            label.innerHTML = "<input class=\"labelMarkbox\" type=\"checkbox\" id=" +
                                groupClass.classID +
            ...
            if(labelIndex>0 && (labelIndex+1)%line_num == 0){
...
function createAppLabelTable(markDiv,groupClass){
    ...
    for(var category in groupClass){
        ...
        for(var label in categoryNode.labels){
            ...
            tr = document.createElement("tr");
            td = document.createElement("td");
            html_label = document.createElement("label");

            html_label.innerHTML = "<input class=\"labelMarkbox\" type=\"checkbox\" id=" +
                                groupClass.classID +
                                categoryNode.categoryID +
                                labelNode.labelID +
                                ">" + labelNode.labelChName;
            td.appendChild(html_label);
            tr.appendChild(td);
            var subLabelNodes = labelNode.subLabels;
            if(subLabelNodes){
                ...
                for(var sublabel in subLabelNodes){
                    subLabelNode = subLabelNodes[sublabel];
                    td_sub = document.createElement("td");
                    html_label_sub = document.createElement("label");
                    html_label_sub.innerHTML = "<input class=\"labelMarkbox\" type=\"checkbox\" id=" +
                                                    groupClass.classID +
                                                    categoryNode.categoryID +
                                                    labelNode.labelID + subLabelNode.subLabelID +
                                                    ">" + subLabelNode.subLabelChName;
                    td_sub.appendChild(html_label_sub);
...
function getAppLabels(){
    ...
    for(var category in app_class){
        ...
        for(var label in categoryNode.labels){
            ...
            videoLabel["label"][categoryNode.categoryEnName][labelID] = {};
            videoLabel["label"][categoryNode.categoryEnName][labelID]["mark"] = document.getElementById(labelID).checked;

            var subLabelNodes = labelNode.subLabels;
            if(subLabelNodes){
                videoLabel["label"][categoryNode.categoryEnName][labelID]["subLabel"] = {};
                for(var sublabel in subLabelNodes){
                    subLabelNode = subLabelNodes[sublabel];
                    subLabelID = app_class.classID + categoryNode.categoryID + labelNode.labelID + subLabelNode.subLabelID;
                    videoLabel["label"][categoryNode.categoryEnName][labelID]["subLabel"][subLabelID] = document.getElementById(subLabelID).checked;
                }
            }
        }
        categoryIndex++;
...
/*
{
    "game":{
        ...
        "method":{
            ...
            "labels":{
                ...
                "survival":{
                    "labelID":"0011",
                    "labelChName":"生存",
                    "labelEnName":"survival",
                    "labelMark":""
                },
                "standalone":{
                    "labelID":"0012",
                    "labelChName":"单机",
                    "labelEnName":"standalone",
                    "labelMark":""
                },
                "sandbox":{
                    "labelID":"0013",
                ...
                "shooting":{
                    "labelID":"0016",
                    "labelChName":"射击",
                    "labelEnName":"shooting",
                    "labelMark":""
                },
                "adventure":{
                    "labelID":"0017",
                    "labelChName":"冒险",
                    "labelEnName":"adventure",
                    "labelMark":""
                },
                "sports":{
                    "labelID":"0018",
                ...
                "simulate":{
                    "labelID":"0019",
                    "labelChName":"模拟",
                    "labelEnName":"simulate",
                    "labelMark":""
                },
                "arcadegame":{
                    "labelID":"0020",
                    "labelChName":"街机",
                    "labelEnName":"arcadegame",
                    "labelMark":""
                },
                "intelligence":{
                    "labelID":"0021",
                    "labelChName":"益智",
                    "labelEnName":"intelligence",
                    "labelMark":""
                },
                "music":{
                    "labelID":"0022",
        ...
        "theme":{
            "categoryID":"0002",
            "categoryChName":"按题材",
            "categoryEnName":"theme",
            "labels":{
                "threekingdoms":{
                    "labelID":"0024",
                    "labelChName":"三国",
                    "labelEnName":"threekingdoms",
                    "labelMark":""
                },
                "westward":{
                    "labelID":"0025",
                    "labelChName":"西游",
                    "labelEnName":"westward",
                    "labelMark":""
                },
                "swordsman":{
                    "labelID":"0026",
                    "labelChName":"武侠",
                    "labelEnName":"swordsman",
                    "labelMark":""
                },
                "legend":{
                    "labelID":"0027",
        ...
        "style":{
            ...
            "labels":{
                ...
                "freshness":{
                    "labelID":"0040",
                    "labelChName":"清新",
                    "labelEnName":"freshness",
                    "labelMark":""
                },
                "aestheticism":{
                    "labelID":"0041",
                    "labelChName":"唯美",
                    "labelEnName":"aestheticism",
                    "labelMark":""
                },
                "ink":{
                    "labelID":"0042",
                ...
                "violence":{
                    "labelID":"0044",
                    "labelChName":"暴力",
                    "labelEnName":"violence",
                    "labelMark":""
                },
                "frightened":{
                    "labelID":"0045",
                    "labelChName":"惊悚",
                    "labelEnName":"frightened",
                    "labelMark":""
                },
                "europe":{
                    "labelID":"0046",
                ...
                "japanese":{
                    "labelID":"0047",
                    "labelChName":"日系",
                    "labelEnName":"japanese",
                    "labelMark":""
                },
                "classical":{
                    "labelID":"0048",
                    "labelChName":"古典",
                    "labelEnName":"classical",
                    "labelMark":""
                },
                "independent":{
                    "labelID":"0049",
                    "labelChName":"独立",
                    "labelEnName":"independent",
                    "labelMark":""
                },
                "drama":{
                    "labelID":"0050",
        ...
        "education":{
            ...
            "labels":{
                "preschool":{
                    "labelID":"0105",
                    "labelChName":"幼教",
                    "labelEnName":"preschool",
                    "labelMark":""
                },
                "middleschool":{
                    "labelID":"0106",
                    "labelChName":"中小学",
                    "labelEnName":"middleschool",
                    "labelMark":""
                },
                "college":{
                    "labelID":"0107",
        ...
        "live":{
            ...
            "labels":{
                ...
                "civilian":{
                    "labelID":"0125",
                    "labelChName":"草根",
                    "labelEnName":"civilian",
                    "labelMark":""
                },
                "television":{
                    "labelID":"0126",
                    "labelChName":"电视",
                    "labelEnName":"television",
                    "labelMark":""
                },
                "sports":{
                    "labelID":"0127",
        ...
        "picture":{
            ...
            "labels":{
                ...
                "recording":{
                    "labelID":"0135",
                    "labelChName":"录像",
                    "labelEnName":"recording",
                    "labelMark":""
                },
                "filmediting":{
                    "labelID":"0136",
                    "labelChName":"剪辑",
                    "labelEnName":"filmediting",
                    "labelMark":""
                },
                "design":{
                    "labelID":"0137",
